...
async def on_message(message: cl.Message):
    ...
    coffee_message = cl.Message(
        author="System", 
        content=f"☕ The Expert Committee is taking a quick **Coffee Break** to prepare their parallel contributions. This ensures we don't hit rate limits and might take {duration}.",
        elements=[],
